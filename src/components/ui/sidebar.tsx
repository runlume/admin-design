...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // Persistence belongs to the controlled Runlume appearance store, not an extra cookie.
    },
    [setOpenProp, open],
  )
...
function SidebarMenuSkeleton({
  ...
  // A stable width avoids random rendering and keeps visual tests deterministic.
  const width = '70%'
