...
| 基础控件   | `/design-system/basic`      | 按钮、输入、选择、勾选、标签、评分、进度、步进、滑块、滚动区、折叠                                    |
| 表单与选择 | `/design-system/form`       | 表单、完整日历、日期时间、穿梭框、验证码、密码强度、组合框、级联、多选、上传、提及                    |
| 数据展示   | `/design-system/data`       | 表格（排序 / 列管理 / 密度 / 固定列 / 行内展开 / 虚拟滚动）、树、表格树、描述列表、分割面板、拖放排序 |
...
| 分类       | 文档                                 | 组件                                                                                                                                                                                      |
| ---------- | ------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 基础控件   | [基础控件](/components/basic)        | Button、Input、Textarea、Checkbox、Switch、RadioGroup、NativeSelect、Badge、Tag、Alert、Rate、Progress、Kbd、NumberField、Slider、ScrollArea、Collapsible、Separator、Skeleton            |
| 表单与选择 | [表单与选择](/components/form)       | Calendar、Transfer、Combobox、Cascader、MultiSelect、Mention、DateInput、DateRangeInput、DateTimeInput、InputOTP、PasswordStrength、FileUpload、ImagePreview、FixedBar                    |
| 数据展示   | [数据展示](/components/data)         | DataTable、EditableTable、Tree、TreeTable、Descriptions、Timeline、PagePager、PaginationBar、CursorPagination、LayoutContainer、ResizablePanel、SortableList、TableToolbar、SearchFilters |
